...
export function TrophyIcon({ size = 22, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function SwordsIcon({ size = 22, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function LeaderboardIcon({ size = 22, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function FireIcon({ size = 18, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
...
export function TournamentIcon({ size = 22, className = "" }) {
  return (
    <svg
      width={size}
      height={size}
